...
// Add scripts to the page head
drupal_add_js( drupal_get_path('theme', 'basic') . '/scripts/scrolling-header.js', 'theme', 'header' );
drupal_add_js( drupal_get_path('theme', 'basic') . '/scripts/slider.js', 'theme', 'header' );
drupal_add_js( drupal_get_path('theme', 'basic') . '/scripts/jquery.lightbox-0.5.js', 'theme', 'header' );
